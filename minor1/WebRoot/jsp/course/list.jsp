  ...
  <META   HTTP-EQUIV=”Expires”   CONTENT=”0”>   
	...
	<script type="text/javascript">
		function query(){
			...
			if(dname=="" || dname==null){
				var url="course.do?method=showCourseByCname&cn="+cname+"&page=null";
  ...
  <form action="" name="roleform" method="post">
  	...
  	<div class="page_title">课程管理</div>
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="course.do?method=showCourses&page=<%=pp-1 %>">上一页</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<a href="course.do?method=showCourses&page=<%=pp+1 %>">下一页</a>
			</c:otherwise>
		</c:choose>
			</DIV>
			</td>
